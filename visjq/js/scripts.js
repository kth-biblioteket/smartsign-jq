$(document).ready(function() {
    ...
    function getVisitors(){
        ...
        console.log(endTime);
        //uppdatera html
        $("#header3").html('<h3>Besöksstatistik / Visitor statistics</h3><div><h4>Ungefärligt antal besökare i biblioteket vid aktuell timmes slut</h4></div>');
        var currenttimestamp = Math.floor(Date.now() /1000);
        //currenttimestamp = 1521299582;
        var html = '';
        $.ajax({
            url: 'https://api.viametrics.com/api/GetCounterData?counterIds=[507]&endTime=' + endTime + '&includeFineGrained=false&periodType=6&snapToPeriodStart=true&startTime=' + startTime + '&userId=342&userToken=',
            /*
            success: function(){
            },
            error: function(){
