    ...
    if(jsonbookings.reservations.length > 0) {
        jsonbookings.reservations.forEach(function(element) {
            ...
            if (eventenddate > currentdate) {
                if(element.columns[3]!=""){ info = ', ' + element.columns[3];}
                html += '<div class="float bookingrow"><div class="eventtime">' + element.starttime.substr(0,5) + ' - ' + element.endtime.substr(0,5) + '</div><div class="eventobject">' + element.columns[1] + '</div><div class="eventtitle"> ' + element.columns[0] + info + '</div></div>';
